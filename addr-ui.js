function paintAddr(){
  ...
  page.innerHTML='<h2>📍 पंडाल</h2><div class="card addrbox">'+
    ...
    '<p>रॉबर्ट्सगंज से घोरावल जाएँ।<br>घोरावल से कोल्डीहा लगभग <b>8 किमी</b>।<br>रॉबर्ट्सगंज से कुल लगभग <b>35–40 किमी</b>।</p>'+
    '<div class="addrh">बस / ट्रेन</div>'+
    '<p>पहले घोरावल पहुँचें।<br>फिर ऑटो / ई-रिक्शा / टैक्सी से कोल्डीहा आएँ।<br>पास में रेलवे स्टेशन नहीं है।</p>'+
...
(function(){
  ...
  paintAddr();
  var g=window.go;
  window.go=function(n){if(typeof g==="function")g(n);if(n==="map"||n==="home")paintAddr();};
  setTimeout(paintAddr,400);
})();
