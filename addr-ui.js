function paintAddr(){
  ...
  page.innerHTML='<h2>📍 पंडाल</h2><div class="card addrbox">'+
    ...
    '<div class="addrrow"><span>ग्राम</span><b>कोलडीहा (Koldiha)</b></div>'+
    '<div class="addrrow"><span>पोस्ट</span><b>घोरावल</b></div>'+
    ...
    '<p style="text-align:center;font-weight:800;color:#6B1212">रॉबर्ट्सगंज → घोरावल → कोलडीहा</p>'+
    '<p>रॉबर्ट्सगंज से घोरावल जाएँ।<br>घोरावल से कोलडीहा लगभग <b>8 किमी</b>।<br>रॉबर्ट्सगंज से कुल लगभग <b>35–40 किमी</b>।</p>'+
    '<div class="addrh">बस / ट्रेन</div>'+
    '<p>पहले घोरावल पहुँचें।<br>फिर ऑटो / ई-रिक्शा / टैक्सी से कोलडीहा आएँ।<br>पास में रेलवे स्टेशन नहीं है।</p>'+
    '<a class="btn" target="_blank" href="https://www.google.com/maps/search/?api=1&query=Koldiha+Ghorwal+Sonbhadra+231210">रास्ता</a></div>';
}
(function(){
  ...
  paintAddr();
  var g=window.go;
  window.go=function(n){if(typeof g==="function")g(n);if(n==="map")paintAddr();};
})();
