...
(function(){["gal-perm.js?v=22","social.js?v=24","chat-ui.js?v=25","notify.js?v=26","fest.js?v=27","notify-extra.js?v=27","welcome.js?v=31","admin-users.js?v=32","pin-dp.js?v=32","live-embed.js?v=33"].forEach(function(src){var s=document.createElement("script");s.src="./"+src;document.body.appendChild(s);});})();
