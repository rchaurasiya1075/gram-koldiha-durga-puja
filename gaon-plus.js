(function(){
  ...
  function injectHome(){
    ...
    if(grid&&!document.getElementById("tileEmer")){
      grid.insertAdjacentHTML("beforeend",
        ...
        '<button class="tile" id="tileTv" type="button" onclick="location.href=\'./tv.html\'"><span>\ud83d\udcfa</span>\u091f\u0940\u0935\u0940</button>'+
        '<button class="tile" id="tilePoster" type="button" onclick="location.href=\'./poster.html\'"><span>\ud83d\udda8\ufe0f</span>\u092a\u094b\u0938\u094d\u091f\u0930</button>'
      );
    }
  }
  window.renderEmergency=function(){
    ...
    var rows=[
      ...
      ["\ud83d\udc6e 112 \u0907\u092e\u0930\u091c\u0947\u0902\u0938\u0940","112"],
      ["\u26a1 \u092c\u093f\u091c\u0932\u0940",s.powerCall||""],
      ["\ud83d\udd0a \u0938\u093e\u0909\u0902\u0921 \u091f\u0940\u092e",s.soundCall||""],
      ["\ud83d\udc51 \u0905\u0927\u094d\u092f\u0915\u094d\u0937 / \u090f\u0921\u092e\u093f\u0928",admin]
    ];
    var html='<h2>\ud83d\udea8 \u0907\u092e\u0930\u091c\u0947\u0902\u0938\u0940</h2><p class="meta">\u0928\u0902\u092c\u0930 \u0926\u092c\u093e\u0913 \u2014 \u0915\u0949\u0932 \u0932\u0917\u0947\u0917\u0940</p>';
    html+='<div class="card"><b>\u0935\u0949\u0915\u0940-\u091f\u0949\u0915\u0940</b><p>\u092a\u0902\u0921\u093e\u0932 \u091a\u0948\u0928\u0932 <b>3</b> \u00b7 \u0907\u092e\u0930\u091c\u0947\u0902\u0938\u0940 \u091a\u0948\u0928\u0932 <b>5</b></p><p class="meta">200 \u092e\u0940\u091f\u0930 \u0915\u0947 \u0932\u093f\u090f \u0935\u0949\u0915\u0940 \u0905\u0932\u0917</p></div>';
    rows.forEach(function(r){
      if(!r[1])html+='<div class="card">'+r[0]+'<p class="meta">\u090f\u0921\u092e\u093f\u0928 \u092c\u093e\u0926 \u092e\u0947\u0902 \u0928\u0902\u092c\u0930 \u0938\u0947\u0935 \u0915\u0930\u0947</p></div>';
      else html+='<a class="btn" href="tel:'+r[1]+'">'+r[0]+' \u00b7 '+r[1]+'</a>';
    });
    html+='<a class="btn ghost" href="./control.html">\u0915\u0902\u091f\u094d\u0930\u094b\u0932 \u0930\u0942\u092e</a>';
    page.innerHTML=html;
  };
  function sevakList(){
    ...
    (d.workers||[]).forEach(function(w){
      var k=w.phone||w.name;
      map[k]={name:w.name||"\u0938\u0947\u0935\u0915",phone:w.phone||"",points:Number(w.points||0),pad:w.pad||""};
    });
    d.sevakLog.forEach(function(x){
      var k=x.phone||x.name;
      if(!map[k])map[k]={name:x.name||"\u0938\u0947\u0935\u0915",phone:x.phone||"",points:0,pad:""};
  ...
  window.addSevakPoint=function(){
    if(!window.user)return typeof toast==="function"&&toast("\u092a\u0939\u0932\u0947 \u0932\u0949\u0917\u093f\u0928")||go("account");
    var sel=document.getElementById("svWork");
    var key=sel?sel.value:"seva";
    var d=window.db||(window.db={});
    d.sevakLog=d.sevakLog||[];
  ...
  window.renderSevak=function(){
    ...
    var list=sevakList();
    var html='<h2>\ud83c\udfc5 \u0938\u0947\u0935\u0915 \u092c\u094b\u0930\u094d\u0921</h2><p class="meta">\u0915\u093e\u092e \u091c\u094b\u0921\u093c\u094b \u2014 \u0917\u094b\u0932\u094d\u0921 / \u0938\u093f\u0932\u094d\u0935\u0930 / \u092c\u094d\u0930\u0949\u0902\u091c</p>';
    html+='<div class="card"><select id="svWork"><option value="pani">\u092a\u093e\u0928\u0940 (+5)</option><option value="bhojan">\u092d\u094b\u091c\u0928 (+8)</option><option value="safai">\u0938\u092b\u093e\u0908 (+8)</option><option value="gate">\u0917\u0947\u091f (+6)</option><option value="light">\u0932\u093e\u0907\u091f (+7)</option><option value="seva">\u0905\u0928\u094d\u092f \u0938\u0947\u0935\u093e (+5)</option></select><button class="btn" type="button" onclick="addSevakPoint()">\u0906\u091c \u0915\u093e \u0915\u093e\u092e \u091c\u094b\u0921\u093c\u094b</button></div>';
    if(!list.length)html+='<p class="meta">\u0905\u092d\u0940 \u0905\u0902\u0915 \u0928\u0939\u0940\u0902</p>';
    list.forEach(function(s,i){
      var b=i===0?"\ud83e\udd47":i===1?"\ud83e\udd48":i===2?"\ud83e\udd49":String(i+1);
      html+='<div class="card"><b>'+b+" "+(s.name||"")+'</b><div class="meta">'+(s.pad||"")+' \u00b7 '+(s.points||0)+' \u0905\u0902\u0915</div></div>';
    });
    page.innerHTML=html;
  };
  ...
  window.go=function(p){
    if(p==="emergency")ensurePage("p-emergency");
    if(p==="sevak")ensurePage("p-sevak");
  ...
  else setTimeout(injectHome,200);
